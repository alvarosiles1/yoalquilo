...
class Registro extends Component {
    ...
    getContent() {
        ...
        return <SForm
            ...
            inputs={{
                key_cliente: { label: "key_cliente", isRequired: true, defaultValue: this.data["key_cliente"] },
                nombre_completo: { label: "nombre_completo", isRequired: true, defaultValue: this.data["nombre_completo"] },
