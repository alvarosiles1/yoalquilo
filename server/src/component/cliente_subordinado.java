...
public class cliente_subordinado {
    private final static String component = "cliente_subordinado";

    public cliente_subordinado(JSONObject obj, SSSessionAbstract sesion) {
